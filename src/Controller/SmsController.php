...
class SmsController extends AbstractController
{
    ...
    private $twilioAccountSid = ''; // Remplacez par votre SID Twilio
    private $twilioAuthToken = ''; // Remplacez par votre jeton d'authentification Twilio
    private $twilioPhoneNumber = ''; // Remplacez par votre numéro de téléphone Twilio
